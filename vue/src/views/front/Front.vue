...
<!--    头部-->
    <div style="display: flex; height: 60px; line-height: 60px; border-bottom: 1px solid #eee">
      <div style="width: 300px; display: flex; padding-left: 30px">
        ...
        <div style="flex: 1">滁州市移动宽带服务系统</div>
      </div>
      <div style="flex: 1">

        <el-menu :default-active="'1'" class="el-menu-demo" mode="horizontal" router>
          <el-menu-item index="/front/home">首页</el-menu-item>
          <el-menu-item index="/front/Bandwidth">宽带列表</el-menu-item>
          <el-menu-item index="/front/Order" >订单管理</el-menu-item>
          <el-menu-item index="/front/Error" >故障上传</el-menu-item>
          <el-menu-item index="/front/Errors" >故障管理</el-menu-item>
        </el-menu>
      </div>
