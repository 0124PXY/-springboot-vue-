<template>
  <div style="height: 100vh; width: 1400px;">
    ...
    <el-table :data="tableData" class="left" border stripe :header-cell-class-name="'headerBg'"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="type" label="宽带类型" width="100">
      </el-table-column>
      <el-table-column prop="router" label="路由器设备" width="120"></el-table-column>
      <el-table-column prop="bandwidth" label="宽带带宽（M）" width="120"></el-table-column>
