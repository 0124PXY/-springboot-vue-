...
export default {
  ...
  data() {
    return {
      imgs: [
          'https://pic.ntimg.cn/file/20220310/3265662_220506785100_2.jpg',
          'https://pic.ntimg.cn/file/20200213/10001959_150924433086_2.jpg'
      ],
      files: []
    }
  },
  created() {
    this.request.get("/echarts/front/all").then(res => {
